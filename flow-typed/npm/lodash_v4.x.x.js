...
declare module 'lodash' {
	...
	declare class Lodash {
		...
		flattenDeep<T>(array?: ?$ReadOnlyArray<any>): $ReadOnlyArray<T>;
...
declare module 'lodash/fp' {
	...
	declare class Lodash {
		...
		remove<T>(predicate: Predicate<T>, array: Array<T>): Array<T>;
		reverse<T>(array: $ReadOnlyArray<T>): Array<T>;
		slice<T>(
			start: number,
		...
		all<T>(iteratee: Iteratee<T> | OIteratee<T>, collection: Collection<T>): boolean;
		filter<T>(
		...
		propOr(defaultValue: any, path: Path, object: Object | $ReadOnlyArray<any>): any;
		pathOr(
			defaultValue: any,
		): ((path: Path) => (object: Object | $ReadOnlyArray<any>) => any) &
			((path: Path, object: Object | $ReadOnlyArray<any>) => any);
		...
		pathOr(defaultValue: any, path: Path, object: Object | $ReadOnlyArray<any>): any;
